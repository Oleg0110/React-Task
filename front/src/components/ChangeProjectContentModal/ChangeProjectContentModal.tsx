...
const ChangeProjectContentModal: React.FC<IModalWindowProps> = ({ isModalOpened, onModalClose, id }) => {
  ...
  const onSubmit = (data: IOnSubmitProps) => ProjectsStore.changedProjecContent(data.content, id)
