...
const Projects: React.FC = ({ children }) => {
   ...
   const projectsByTitle: Array<IProjects> = projects.filter(found => found.title.toLowerCase().includes(searchTitle.toLowerCase()))
   const projectsByContent: Array<IProjects> = projects.filter(found => found.content.toLowerCase().includes(searchContent.toLowerCase()))
